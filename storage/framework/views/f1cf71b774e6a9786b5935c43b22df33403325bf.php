...
<div class="container">
    ...
    <form method="POST" action="/projects" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <input id="judul" type="text" class="form-control<?php echo e($errors->has('judul') ? ' is-invalid' : ''); ?>" name="judul" value="<?php echo e(old('judul')); ?>" required>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <input id="dibuat" type="date" class="form-control<?php echo e($errors->has('dibuat') ? ' is-invalid' : ''); ?>" name="dibuat" value="<?php echo e(old('dibuat')); ?>" required>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <input id="ditutup" type="date" class="form-control<?php echo e($errors->has('ditutup') ? ' is-invalid' : ''); ?>" name="ditutup" value="<?php echo e(old('ditutup')); ?>" required>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <textarea rows="4" cols="50" style="resize:none" id="deskripsi" type="text" class="form-control<?php echo e($errors->has('deskripsi') ? ' is-invalid' : ''); ?>" name="deskripsi" value="<?php echo e(old('deskripsi')); ?>" required></textarea>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <input id="jumlah_uang" type="number" class="form-control<?php echo e($errors->has('jumlah_uang') ? ' is-invalid' : ''); ?>" name="jumlah_uang" value="<?php echo e(old('jumlah_uang')); ?>" required>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-6">
              <input id="featured_image" type="file" class="form-control<?php echo e($errors->has('featured_image') ? ' is-invalid' : ''); ?>" name="featured_image" value="<?php echo e(old('featured_image')); ?>" required>
