...
<div class="container">
    ...
    <?php endif; ?>
     <form method="POST" action="/projects/<?php echo e($project->id); ?>" enctype="multipart/form-data">
          ...
          <label for="title" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Judul Proyek')); ?></label>
           <div class="col-md-6">
              <input id="title" type="text" class="form-control<?php echo e($errors->has('title') ? ' is-invalid' : ''); ?>" name="title"
                  value="<?php echo e(old('title') ? old('title') : $project->title); ?>" required>
       ...
       <div class="form-group row">
          <label for="opened_at" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Tanggal dibuat project')); ?></label>
           <div class="col-md-6">
              <input id="opened_at" type="datetime" class="form-control<?php echo e($errors->has('opened_at') ? ' is-invalid' : ''); ?>" name="opened_at"
                  value="<?php echo e(old('opened_at') ? old('opened_at') : $project->opened_at); ?>" required>
       ...
       <div class="form-group row">
          <label for="closed_at" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Tanggal ditutup project')); ?></label>
           <div class="col-md-6">
              <input id="closed_at" type="datetime" class="form-control<?php echo e($errors->has('closed_at') ? ' is-invalid' : ''); ?>" name="closed_at"
                  value="<?php echo e(old('closed_at') ? old('closed_at') : $project->closed_at); ?>" required>
       ...
       <div class="form-group row">
          <label for="description" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Deskripsi Project')); ?></label>
           <div class="col-md-6">
              <textarea rows="4" cols="50" style="resize:none" id="description" type="text" class="form-control<?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" name="description"
                  value="<?php echo e(old('description') ? old('description') : $project->description); ?>" required></textarea>
       ...
       <div class="form-group row">
          <label for="project_price" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Dana yang Dibutuhkan')); ?></label>
           <div class="col-md-6">
              <input id="project_price" type="number" class="form-control<?php echo e($errors->has('project_price') ? ' is-invalid' : ''); ?>" name="project_price"
                  value="<?php echo e(old('project_price') ? old('project_price') : $project->project_price); ?>" required>
       ...
       <div class="form-group row">
          <label for="slot" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Submit Gambar')); ?></label>
           <div class="col-md-6">
              <input id="project_image" type="file" class="form-control<?php echo e($errors->has('project_image') ? ' is-invalid' : ''); ?>" name="project_image"
                value="<?php echo e(old('project_image') ? old('project_image') : $project->project_image); ?>" required>
