              ...
              <ul class="navbar-nav ml-auto">
                <?php if(Route::has('login')): ?>
                  <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php else: ?>
                      <li class="nav-item">
                          <a class="nav-link h5" href="<?php echo e(route('login')); ?>">Masuk</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link h5" href="<?php echo e(route('register')); ?>">Daftar</a>
                      </li>
                  <?php endif; ?>
                <?php endif; ?>
              </ul>
                  ...
                  <!--Card-->
                    ...
                    <div class="card card-cascade narrower mb-4" style="margin-top: 28px">
                        ...
                        <div class="view view-cascade">
                            ...
                            <img src="<?php echo e(asset('storage/project_image/' . $project->project_image)); ?>" class="card-img-top" alt="">
                            <a>
                        ...
                        <div class="card-body card-body-cascade">
                            <h5 class="pink-text"></i><?php echo e($project->title); ?></h5>
                            <!--Title-->
                            <h6 class="card-title">Rp.<?php echo e($project->project_price); ?></h6>
