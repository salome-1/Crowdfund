    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped" border="solid">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo e($topup->username); ?></td>
            <td><?php echo e($topup->bank); ?></td>
            <td><?php echo e($topup->user_name); ?></td>
            <td><?php echo e($topup->nominal); ?></td>
            <td><img src="<?php echo e(asset('storage/proof_image/' . $topup->proof_image)); ?>" alt="" width="50"></td>
            <td>
            ...
            <td><a href="<?php echo e(action('TopupController@edit', $topup->id)); ?>" class="btn btn-warning">Action</a></td>
          </tr>
